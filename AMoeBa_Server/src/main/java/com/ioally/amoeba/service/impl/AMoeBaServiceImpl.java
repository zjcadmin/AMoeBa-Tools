...
import com.ioally.amoeba.tasks.AMoeBaExecuteThread;
...
public class AMoeBaServiceImpl implements AMoeBaService {
    ...
    public String batchSave(BatchExecuteDto batchExecuteDto) throws Exception {
        ...
        for (LogInfoDto logInfoDto : logInfoDtos) {
            ...
            if (multiThread) {
                AMoeBaExecuteThread.instance(aMoeBaSession, AMoeBaSession.ADD_ACTION, aMoeBaLogDtos.toArray(new AMoeBaLogDto[aMoeBaLogDtos.size()]))
                        .session(BaseRequestDto.sessionThreadLocal.get())
                        .execute();
            } else {
    ...
    public String batchDelete(List<String> logIds) throws Exception {
        ...
        try {
            ...
            if (multiThread) {
                ...
                AMoeBaExecuteThread.instance(aMoeBaSession, AMoeBaSession.DELETE_ACTION, aMoeBaLogDtos)
                        .session(BaseRequestDto.sessionThreadLocal.get())
                        .execute();
            } else {
